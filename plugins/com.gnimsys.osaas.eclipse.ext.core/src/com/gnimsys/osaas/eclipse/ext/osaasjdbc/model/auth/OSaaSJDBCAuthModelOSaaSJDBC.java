 ...
 */
public class OSaaSJDBCAuthModelOSaaSJDBC<CREDENTIALS extends AuthModelOSaaSJDBCCredentials>
    extends AuthModelDatabaseNative<CREDENTIALS> {

    public static final String ID = "osaasjdbc_osaasjdbc";

    @NotNull
    @Override
    public CREDENTIALS createCredentials() {
        return (CREDENTIALS) new AuthModelOSaaSJDBCCredentials();
    }
