 ...
 */
package com.gnimsys.osaas.eclipse.ext.osaasjdbc.ui.internal;

import org.eclipse.osgi.util.NLS;

public class OSaaSJDBCMessages extends NLS {
	private static final String BUNDLE_NAME = "com.gnimsys.osaas.eclipse.ext.osaasjdbc.ui.internal.OSaaSJDBCResources"; //$NON-NLS-1$
	...
	public static String dialog_setting_licenseKey;
	public static String dialog_setting_licenseMIdent;
	public static String dialog_setting_licenseDetailes;
	static {
		// initialize resource bundle
		NLS.initializeMessages(BUNDLE_NAME, OSaaSJDBCMessages.class);
	}

	private OSaaSJDBCMessages() {
	}
}
